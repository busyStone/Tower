...
public class YesNoWithPrefsDialog extends YesNoDialog {
    ...
    public static YesNoWithPrefsDialog newInstance(Context context, String dialogTag, String title,
    ...
    public static YesNoWithPrefsDialog newInstance(Context context, String dialogTag, String title, String msg,
                                                   String positiveLabel, String negativeLabel, String prefKey, Listener listener) {
        if (dialogTag == null)
