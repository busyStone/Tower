...
public class DownloadAMapMapActivity : AppCompatActivity() {
    val MAP_CACHE_ZOOM_LEVEL = 19
    val MAP_ID = "amap.web"

    private val mapDownloader: AMapDownloader by lazy(LazyThreadSafetyMode.NONE) {
        val dpApp = application as DroidPlannerApp
        dpApp.amapDownloader
    }
    ...
    private fun triggerMapDownload() {
        ...
        mapDownloader.beginDownloadingMapID(MAP_ID, "", mapArea, 0, MAP_CACHE_ZOOM_LEVEL)
    }
